...
public class Agent4_Controller : MonoBehaviour {
	...
	void Update () {
		...
		if (mouse_controller.destination_go&&mouse_controller.state_of_agent==4&&set_destination == true) //before going set to zero.
		{
