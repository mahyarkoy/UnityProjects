...
public class P3_PlayerController : MonoBehaviour
{
	...
	void Update()
    {
      ...
      //if (run > 0)
          //  effectiveSpeed *= 2;
		//if (mouse_controller.state_of_agent ==0)//idle

		if (mouse_controller.state_of_agent == 1||mouse_controller.state_of_agent ==0) { //
