...
public class Story_Monitor : MonoBehaviour
{
	...
	public GameObject meeting_position;

	//public Behavior_Tree_Monitor c;
...
protected Node ST_story_one() //position, and participants.
{
	return //two of these true.
		new SelectorParallel(this.ST_story_one_arc(),new LeafWait(10000));
}
*/
...
{
	return
		new DecoratorLoop(new Sequence(/*this.ST_story_one(),*/ST_Appraoch_at_certain_raidusAndWait(Daniel,meeting_position.transform,2)));//,ST_story_two,ST_story_three,ST_story_four));
